...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        if (HTML5_DEBUG) {
            ...
            // perfect scrollbar
            wp_register_script('perfect-scrollbar', get_template_directory_uri() . '/js/lib/perfect-scrollbar.js', array(), '1.0.0');
...
function html5wp_search_more($length) // Create 20 Word Callback for Index page Excerpts, call using html5wp_excerpt('html5wp_index');
{
    return ' [...]';
}
